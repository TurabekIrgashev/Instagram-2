    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-center justify-center minh-[800px] sm:min-h-screen pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block overflow-hidden text-left align-middle transition-all transform bg-white rounded-lg shadow-xl my-52 sm:align-middle sm:max-w-sm sm:w-full ">
